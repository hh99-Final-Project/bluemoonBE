...
public enum ErrorCode {
    ...
    //POST
    CANNOT_DELETE_NOT_EXSIST_POST(HttpStatus.NOT_FOUND.value(), "P001","해당 게시물을 찾을 수 없습니다."),
    CANNOT_FIND_POST_NOT_EXSIST(HttpStatus.NOT_FOUND.value(), "P002","해당 게시물을 찾을 수 없습니다."),
    ONLY_CAN_DELETE_POST_WRITER(HttpStatus.FORBIDDEN.value(), "P003","게시글 작성자 만이 게시글을 삭제할 수 있습니다."),
    DOESNT_EXSIST_MAIN_POST_FOR_ANONYMOUS(HttpStatus.NOT_FOUND.value(), "P004","남이 쓴 게시글이 존재하지 않습니다."),
    DOESNT_EXSIST_POST_FOR_ANONYMOUS(HttpStatus.NOT_FOUND.value(), "P005","해당하는 게시글이 존재하지 않습니다."),
    ...
    //COMMENT
    DOESNT_EXSIST_POST_FOR_WRITE(HttpStatus.NOT_FOUND.value(), "C001","해당하는 게시글이 존재하지 않습니다."),
    DOESNT_EXSIST_POST_FOR_DELETE(HttpStatus.NOT_FOUND.value(), "C002","해당하는 게시글이 존재하지 않습니다."),
