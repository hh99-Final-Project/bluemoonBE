...
class PointServiceTest {
    ...
    public void test() {
        User user = new User("email123", "password", "nickname");
        User email = userRepository.findByUsername("email123").orElse(null);
        System.out.println(email);
        userRepository.save(user);
        email = userRepository.findByUsername("email123").orElse(null);
        System.out.println(email);
    ...
    public void userPoint1() {
        User user = userRepository.findByUsername("email123").get();
    ...
    public void userPoint2() {
        ...
        user = userRepository.findByUsername("email123").get();
